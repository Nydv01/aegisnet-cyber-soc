      ...
      for (let i = 0; i < drops.length; i++) {
        ...
        if (attackActive) {
          ...
          if (Math.random() < intensity * 0.4) {
            ctx.fillStyle = 'rgba(239, 68, 68, 0.45)'; // Threat Red
          } else {
            ctx.fillStyle = 'rgba(34, 211, 238, 0.2)'; // Faded Cyan
          }
        } else {
          // Normal state: glowing cyber cyan/blue shades
          ctx.fillStyle = Math.random() < 0.15 
            ? 'rgba(34, 211, 238, 0.35)' // Glowing Cyan
            : 'rgba(59, 130, 246, 0.15)'; // Deep blue
        }
